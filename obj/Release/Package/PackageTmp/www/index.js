...
function initializeViewer(urn) {
    ...
    function onExtensionLoaded(event) {
        ...
        const navTools = _viewer.toolbar.getControl('navTools');
        ...
        settingsTools.removeControl('toolbar-explodeTool');
        ...
        const modelTools = _viewer.toolbar.getControl('modelTools');
        modelTools.removeControl('toolbar-explodeTool');
        modelTools.removeControl('toolbar-sectionTool');

        //_viewer.removeEventListener(Autodesk.Viewing.EXTENSION_LOADED_EVENT, onExtensionLoaded);
    ...
    function onViewerGeometryLoaded(event) {
        ...
        // Force Layer Managet button off
        _viewer.unloadExtension("Autodesk.LayerManager");
